...
class FilterCut():
    ...
    # def __init__(self, user_dict_file='/home/tdlab/recommender/data180302/dict/userdict.txt'):
    def __init__(self, user_dict_file='/root/recommender/data180302/dict/userdict.txt'):
