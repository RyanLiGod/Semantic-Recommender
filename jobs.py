...
raws = ['/testdata400/data/recommender/data0828/corpus/paper_corpus.txt',
        '/testdata400/data/recommender/data0828/corpus/patent_corpus.txt', '/data/word2vec/data/raw/project.txt']
cuts = ['/testdata400/data/recommender/data0828/cut/paper.cut', '/testdata400/data/recommender/data0828/cut/patent.cut',
        '/testdata400/data/recommender/data0828/cut/project.cut']
vecs = ['/testdata400/data/recommender/data0828/vec/paper.vec', '/testdata400/data/recommender/data0828/vec/patent.vec',
        '/testdata400/data/recommender/data0828/vec/project.vec']
indx = ['/testdata400/data/recommender/data0828/ind/paper.ind', '/testdata400/data/recommender/data0828/ind/patent.ind',
        '/testdata400/data/recommender/data0828/ind/project.ind']
