...
class Recommander(object):
    ...
    def buildFeatureIndex(self):
        ...
        paperFeature = open("/data/Recommender/data180526/feature/paper_feature180526.txt", 'r')
        patentFeature = open("/data/Recommender/data180526/feature/patent_feature180526.txt", 'r')
        projectFeature = open("/data/Recommender/data180526/feature/project_feature180526.txt", 'r')
        featureIndex = {}
