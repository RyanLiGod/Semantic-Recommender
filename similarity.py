...
fields_list = ['A1', 'C1', 'A4', 'A2', 'A9', 'C2', 'A5', 'A3', 'Z1', 'Z9']
...
class Recommander(object):
    def __init__(self, vec_file, pap, pat, pro):
        ...
        self.paper_index = self.load_index(pap)
        self.patent_index = self.load_index(pat)
        self.project_index = self.load_index(pro)
            ...
            for unit_type in unit_types:
                ...
                for parent, dirnames, filenames in os.walk(path + field + '/' + unit_type + '/'):
                    for filename in filenames:
                        ...
                        #         'A4' in os.path.join(parent, filename) or 'A5' in os.path.join(parent, filename) or 'A9' in os.path.join(parent, filename) or 'project' in os.path.join(parent, filename)):
    ...
    def getSimExpertsIds(self, topDocs):
        ...
        for typee in topDocs:
            ...
            docExpertIds = db.getAuthors(typee, ids)
